...
-- @param locale Name of the locale to register, e.g. "frFR", "deDE", etc.
-- @param isDefault If this is the default locale being registered (your addon is written in this language, generally frFR)
-- @param silent If true, the locale will not issue warnings for missing keys. Can only be set on the default locale.
-- @usage
-- -- frFR.lua
-- local L = LibStub("AceLocale-3.0"):NewLocale("TestLocale", "frFR", true)
-- L["string1"] = true
--
-- -- deDE.lua
