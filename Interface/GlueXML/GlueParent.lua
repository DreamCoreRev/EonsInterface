...
function SetBackgroundModel(model, race, class)
	...
	if (model == CharacterCreate) then
		...
		elseif (GetSelectedRace() == 5) then -- Draenei Alliance
			name = 'Draenei';
		elseif (GetSelectedRace() == 6) then -- Pandaren Alliance
			name = 'Pandaren';
		
		elseif (GetSelectedRace() == 7) then -- Orc Horde
			name = 'Horde';
		elseif (GetSelectedRace() == 8) then -- Mort Vivant Horde
			name = 'Scourge';
		elseif (GetSelectedRace() == 9) then -- Tauren Horde
			name = 'Tauren';
		elseif (GetSelectedRace() == 10) then -- Troll Horde
			name = 'Trol2';
		elseif (GetSelectedRace() == 11) then -- Elfe de sang Horde
			name = 'BloodElf';
		elseif (GetSelectedRace() == 12) then -- Pandaren Horde
			name = 'Pandaren';
